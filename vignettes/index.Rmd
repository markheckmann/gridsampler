...
The GUI displayed in the image below consists of a single display made up of three panes. In pane 1. and 2. the parameters for the specific study are set. In panel 3. the simulations are prompted and its results are displayed. In the following the panes are explained.
