...
All parameters can either be given as numeric values separated by commas or using the colon operator from R, i.e. `1:3` for `1, 2, 3`. A mixture of the two, for example,  `1:3, 5` is also possible. 
